...
# (Batch size) < (number of training samples) allows us not to overload machine memory + frequently update weights matrix.
# Note that batch size has an ambigious effect on gradient estimation accuracy.
...
def build_model(cfg: Dict) -> torch.nn.Module:
    ...
    # Add current frame
    # EGO frames and Agents' frames go into separate channels, therefore multiplication by 2
